  ...
  page: {
    ...
    manage: {
      ...
      dept: {
        ...
        parentDeptPlaceholder: 'Empty for top-level',
        addChild: 'Add Child',
        addDept: 'Add Dept',
        editDept: 'Edit Dept',
        selectTip: 'Select a department on the left'
      },
      monitor: {
        ...
        redisMaxMemory: 'Max Memory',
        redisKeys: 'Keys',
        redisOps: 'Ops/sec',
        sessions: 'Online Users',
        sessUsername: 'Username',
        sessNickname: 'Nickname',
        sessIp: 'IP',
        sessBrowser: 'Browser',
        sessOs: 'OS',
        sessStatus: 'Status',
        ...
        sessOffline: 'Offline',
        revoke: 'Revoke',
        revokeConfirm: 'Confirm to revoke this session?'
      },
      log: {
        title: 'Log Management',
        loginLog: 'Login Log',
        operaLog: 'Operation Log',
        username: 'Username',
        ip: 'IP',
        browser: 'Browser',
        os: 'OS',
        ...
        operaTitle: 'Operation',
        method: 'Method',
        path: 'Path',
        costTime: 'Cost(ms)',
        operaTime: 'Operation Time',
        clearAll: 'Clear All',
        clearConfirm: 'Confirm to clear all logs?'
      }
    }
  },
  userCenter: {
